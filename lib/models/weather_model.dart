...
class WeatherModel {
  ...
  factory WeatherModel.fromJson(Map<String, dynamic> json) => WeatherModel(
    ...
    currentObservation: json["current_observation"] == null ? null : CurrentObservation.fromJson(json["current_observation"]),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "forecasts": forecasts == null ? [] : List<dynamic>.from(forecasts!.map((x) => x.toJson())),
  };
}
...
class CurrentObservation {
  ...
  factory CurrentObservation.fromJson(Map<String, dynamic> json) => CurrentObservation(
    ...
    atmosphere: json["atmosphere"] == null ? null : Atmosphere.fromJson(json["atmosphere"]),
